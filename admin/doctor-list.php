					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								...
								<a style="float:right;" class="btn btn-success" href="doctor-add.php">Add Doctor</a>
												 ...
												 <tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="profile.php?edit=<?php echo htmlentities($result->uid);?>" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="assets/img/profile/<?php echo htmlentities($result->profile_picture); ?>" alt="User Image"></a>
													...
													<td><a class="btn btn-sm bg-success-light" href = "doctor-edit.php?edit=<?php echo htmlentities($result->uid);?>"> <i class="fe fe-pencil"></i> Edit</a>

                    <a class="btn btn-sm bg-danger-light" href = "doctor-list.php?del=<?php echo htmlentities($result->uid);?>" onclick = "return confirm('Do you really want to Delete this Doctor')"><i class="fe fe-trash"></i> Delete</a>
                    </td>
												</tr> 
												<?php $cnt = $cnt + 1;
												}
